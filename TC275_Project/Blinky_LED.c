...
#define LED2    &MODULE_P00,6   /* LED D107: Port, Pin definition       */
#define PORT   &MODULE_P00,8
...
void initLED(void)
{
    ...
    /* Initialization of the LED used in this example */
    IfxPort_setPinModeOutput(PORT, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
...
void blinkLED(void)
{
    ...
    IfxPort_togglePin(PORT);                                                /* Toggle the state of the LED      */
