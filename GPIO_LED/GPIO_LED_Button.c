...
/*-----------------------------------------------------Macros--------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED5     &MODULE_P00,5   //h
#define LED6    &MODULE_P00,6   //l     /* Port pin for the LED     */
#define PORT    &MODULE_P02,4   /* Port pin for the button  */
...
void control_LED(void)
{
    ...
    if(IfxPort_getPinState(PORT) == 0)
    {
        ...
        IfxPort_setPinState(LED5, IfxPort_State_low);
    }
    else
    {
        IfxPort_setPinState(LED5, IfxPort_State_high);
        IfxPort_setPinState(LED6, IfxPort_State_low);
    }
}
